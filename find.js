    ...
    getUserIP(function (ip) {
        ...
        findServers(6969, ipBase, 1, 255, 20, timeout, function (servers) {
            ...
            if (servers.length !== 0) {
                ...
                document.getElementById("info").innerHTML = "Could not find a server.</br></br>Are you connected to the correct network?</br>Are you connected through a VPN?</br>Is the server running?";
